    ...
    <Card>
      ...
      <CardContent className="space-y-5">
          ...
          <table className="min-w-full text-left text-sm">
            <thead className="bg-slate-50/80 text-xs uppercase tracking-[0.14em] text-muted-foreground">
              <tr>
                ...
                <th className="px-5 py-4 font-medium">Valor unit.</th>
                <th className="px-5 py-4 font-medium">Total</th>
                <th className="px-5 py-4 font-medium">Cliente/Pedido</th>
            ...
            <tbody className="divide-y divide-slate-100 bg-white/70">
              {sales.map((sale) => (
                <tr key={sale.id} className="transition hover:bg-slate-50/70">
                  <td className="px-5 py-4 text-slate-700">{formatDateBR(sale.sale_date)}</td>
                  ...
                  <td className="px-5 py-4 text-slate-700">{sale.quantity}</td>
        ...
        <div className="grid gap-4 lg:hidden">
          {sales.map((sale) => (
            <div key={sale.id} className="rounded-[30px] border border-[rgba(16,46,94,0.08)] bg-white/[0.86] p-5 shadow-soft">

    ...
    <Card className="brand-shell brand-frost overflow-hidden">
      <CardHeader className="flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="space-y-2">
          ...
          <CardTitle>Historico comercial</CardTitle>
          <p className="max-w-xl text-sm leading-6 text-muted-foreground">
            Ultimas vendas registradas para acompanhar status, volume e faturamento.
          </p>
        </div>
        <Link
          href="/sales"
      ...
      <CardContent>
        {sales.length ? (
          <div className="overflow-hidden rounded-[22px] border border-[rgba(16,46,94,0.08)] md:rounded-[26px]">
          ...
          <div className="rounded-[24px] border border-dashed border-slate-200 px-6 py-12 text-center text-sm text-muted-foreground md:rounded-[28px]">
            Ainda nao existem vendas registradas para exibir.
          </div>
        )}
      </CardContent>
    </Card>

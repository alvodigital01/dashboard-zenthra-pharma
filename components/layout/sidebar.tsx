...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "brand-dark-panel fixed inset-y-2 left-2 z-50 flex w-[calc(100vw-1rem)] max-w-[360px] flex-col overflow-hidden rounded-[30px] border border-white/10 px-4 py-4 text-white shadow-float transition-all duration-300 md:sticky md:top-4 md:h-[calc(100vh-2rem)] md:w-[292px] md:max-w-none md:self-start md:rounded-[34px] md:px-5 md:py-6",
      ...
      >
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute bottom-20 left-[-54px] h-52 w-52 rounded-[46%] bg-[radial-gradient(circle_at_center,rgba(197,47,48,0.2),transparent_68%)]" />
          <div className="absolute -left-12 top-[42%] h-1 w-44 -rotate-12 bg-[linear-gradient(90deg,transparent,rgba(197,47,48,0.72),transparent)]" />
        </div>

        <div className="relative flex h-full min-h-0 flex-col">
          <div className="flex items-center justify-between gap-3">
            <BrandLogo compact theme="dark" subtitle="Bancos & espumas" />
            <button
              type="button"
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        active
                          ? "bg-[#c7a662] text-[#15130f] shadow-soft"
                    ...
                    >
                      ...
                      <div className="flex min-w-0 flex-1 items-center justify-between gap-3">
                        ...
                        {active ? <ArrowUpRight className="h-4 w-4 shrink-0 text-[#4d3a1d]" /> : null}
                      </div>
                    </Link>
                  );
                })}
          ...
          <div className="mt-4 space-y-3 rounded-[24px] border border-white/10 bg-white/5 p-4 backdrop-blur-sm md:mt-6 md:rounded-[28px]">
            ...
            <Link
              ...
              className={buttonVariants({
                className:
                  "w-full justify-center bg-[linear-gradient(135deg,#e0bf79,#b98c3e)] text-[#15130f] hover:-translate-y-0.5 hover:brightness-105"
              })}
            >
